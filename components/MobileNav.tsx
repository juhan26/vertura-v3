...
import { logo, mobileLogo, vertura } from "@/public";
...
export default function MobileNav() {
	...
	return (
		<>
			<div className="w-full hidden justify-between items-center h-[8vh] padding-x sm:flex xm:flex md:flex bg-black">
				<Link href={"/"}>
					<Image
						src={vertura}
						alt="ochi logo"
			...
			<AnimatePresence mode="wait">
				{toggle && (
					<motion.div
						...
						<div className="w-full flex justify-between items-center h-[8vh] border-b border-white padding-x">
							<Link href={"/"}>
								<Image
									src={vertura}
									alt="ochi logo"
